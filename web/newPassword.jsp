...
<html lang="en">
    ...
    <body>
        ...
        <section class="reset-password-body">
            <form action="newPassword" method="POST" class="mx-auto">
                <div class="bg-white p-5 form-login">
                    ...
                    <div class="border-bottom">
                        ...
                        <div class="d-flex align-items-center fs-4 mt-3">
                            <i class='bx bx-key'></i>
                            <input type="password" name="password" placeholder="New Password" class="w-100 py-4 outline-0 border-0 ms-3" required />
                        </div>
                    </div>
                    <div class="border-bottom mt-4">
                        ...
                        <div class="d-flex align-items-center fs-4 mt-3">
                            <i class='bx bx-key'></i>
                            <input type="password" name="confPassword" placeholder="Confirm New Password" class="w-100 py-4 outline-0 border-0 ms-3" required />
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <div class="error-message">${message != null ? message : ""}</div>
                    </div>
                    <button type="submit" class="d-flex align-items-center justify-content-center mt-5 fw-bold py-2 fs-4 px-5 btn bg-danger text-white mx-auto">Reset</button>
